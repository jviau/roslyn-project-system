...
msbuild /nologo /nodeReuse:%NodeReuse% /consoleloggerparameters:Verbosity=diagnostic /fileLogger /fileloggerparameters:LogFile="%LogFile%";verbosity=diagnostic /t:"%MSBuildTarget%" /p:Configuration="%BuildConfiguration%" "%Root%build\build.proj" %MSBuildAdditionalArguments%
if ERRORLEVEL 1 (
    echo.
